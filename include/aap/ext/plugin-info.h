...
typedef aap_port_direction (*get_port_direction_property_func)(void* context);
typedef aap_content_type (*get_content_type_property_func)(void* context);
typedef uint32_t (*get_uint32_property_func)(void* context);
typedef float (*get_float_property_func)(void* context);
typedef const char* (*get_string_property_func)(void* context);

typedef struct aap_plugin_info_port_t {
    void *context;
    get_uint32_property_func index;
    get_string_property_func name;
    get_content_type_property_func content_type;
    get_port_direction_property_func direction;
} aap_plugin_info_port_t;

typedef aap_plugin_info_port_t (*get_plugin_info_get_port_func)(void* context, uint32_t port);

typedef struct aap_plugin_info_parameter_t {
    void *context;
    get_uint32_property_func id;
    get_string_property_func name;
    get_float_property_func min_value;
    get_float_property_func max_value;
    get_float_property_func default_value;
} aap_plugin_info_parameter_t;

typedef aap_plugin_info_port_t (*get_plugin_info_get_port_func)(void* context, uint32_t port);
typedef aap_plugin_info_parameter_t (*get_plugin_info_get_parameter_func)(void* context, uint32_t port);

typedef struct aap_plugin_info_t {
    void *context;
    get_string_property_func plugin_package_name;
    get_string_property_func plugin_local_name;
    get_string_property_func display_name;
    get_string_property_func manufacturer_name;
    get_string_property_func version;
    get_string_property_func primary_category;
    get_string_property_func identifier_string;
    get_string_property_func plugin_id;

    get_uint32_property_func get_port_count;
    get_plugin_info_get_port_func get_port;
    get_uint32_property_func get_parameter_count;

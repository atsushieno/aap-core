...
public:
  ...
  virtual ::ndk::ScopedAStatus beginCreate(const std::string& in_pluginId, int32_t* _aidl_return) = 0;
  ...
  virtual ::ndk::ScopedAStatus endPrepare(int32_t in_instanceID, int32_t in_frameCount, int32_t in_sampleRate) = 0;

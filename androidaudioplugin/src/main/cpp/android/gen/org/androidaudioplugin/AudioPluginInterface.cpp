...
static binder_status_t _aidl_org_androidaudioplugin_AudioPluginInterface_onTransact(AIBinder* _aidl_binder, transaction_code_t _aidl_code, const AParcel* _aidl_in, AParcel* _aidl_out) {
  (void)_aidl_in;
  (void)_aidl_out;
  ...
  switch (_aidl_code) {
    ...
    case (FIRST_CALL_TRANSACTION + 1 /*beginCreate*/): {
      ...
      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_pluginId);
      if (_aidl_ret_status != STATUS_OK) break;

      ::ndk::ScopedAStatus _aidl_status = _aidl_impl->beginCreate(in_pluginId, &_aidl_return);
      _aidl_ret_status = AParcel_writeStatusHeader(_aidl_out, _aidl_status.get());
      if (_aidl_ret_status != STATUS_OK) break;
    ...
    case (FIRST_CALL_TRANSACTION + 2 /*addExtension*/): {
      ...
      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_sharedMemoryFD);
      if (_aidl_ret_status != STATUS_OK) break;
    ...
    case (FIRST_CALL_TRANSACTION + 7 /*prepareMemory*/): {
      ...
      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_shmFDIndex);
      if (_aidl_ret_status != STATUS_OK) break;
    ...
    case (FIRST_CALL_TRANSACTION + 8 /*endPrepare*/): {
      ...
      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_frameCount);
      if (_aidl_ret_status != STATUS_OK) break;

      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_sampleRate);
      if (_aidl_ret_status != STATUS_OK) break;

      ::ndk::ScopedAStatus _aidl_status = _aidl_impl->endPrepare(in_instanceID, in_frameCount, in_sampleRate);
      _aidl_ret_status = AParcel_writeStatusHeader(_aidl_out, _aidl_status.get());
      if (_aidl_ret_status != STATUS_OK) break;
    ...
    case (FIRST_CALL_TRANSACTION + 10 /*process*/): {
      ...
      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_timeoutInNanoseconds);
      if (_aidl_ret_status != STATUS_OK) break;
...
static AIBinder_Class* _g_aidl_org_androidaudioplugin_AudioPluginInterface_clazz = ::ndk::ICInterface::defineClass(IAudioPluginInterface::descriptor, _aidl_org_androidaudioplugin_AudioPluginInterface_onTransact);
...
::ndk::ScopedAStatus BpAudioPluginInterface::setCallback(const std::shared_ptr<::aidl::org::androidaudioplugin::IAudioPluginInterfaceCallback>& in_callback) {
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION && IAudioPluginInterface::getDefaultImpl()) {
    _aidl_status = IAudioPluginInterface::getDefaultImpl()->setCallback(in_callback);
...
::ndk::ScopedAStatus BpAudioPluginInterface::beginCreate(const std::string& in_pluginId, int32_t* _aidl_return) {
  binder_status_t _aidl_ret_status = STATUS_OK;
  ::ndk::ScopedAStatus _aidl_status;
  ::ndk::ScopedAParcel _aidl_in;
  ::ndk::ScopedAParcel _aidl_out;
  ...
  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_in.get(), in_pluginId);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION && IAudioPluginInterface::getDefaultImpl()) {
    _aidl_status = IAudioPluginInterface::getDefaultImpl()->beginCreate(in_pluginId, _aidl_return);
    goto _aidl_status_return;
  }
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::ScopedAStatus BpAudioPluginInterface::addExtension(int32_t in_instanceID, const std::string& in_uri, const ::ndk::ScopedFileDescriptor& in_sharedMemoryFD, int32_t in_size) {
  ...
  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_in.get(), in_sharedMemoryFD);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::ScopedAStatus BpAudioPluginInterface::beginPrepare(int32_t in_instanceID) {
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION && IAudioPluginInterface::getDefaultImpl()) {
    _aidl_status = IAudioPluginInterface::getDefaultImpl()->beginPrepare(in_instanceID);
    goto _aidl_status_return;
  }
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::ScopedAStatus BpAudioPluginInterface::prepareMemory(int32_t in_instanceID, int32_t in_shmFDIndex, const ::ndk::ScopedFileDescriptor& in_sharedMemoryFD) {
  ...
  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_in.get(), in_shmFDIndex);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::ScopedAStatus BpAudioPluginInterface::endPrepare(int32_t in_instanceID, int32_t in_frameCount, int32_t in_sampleRate) {
  binder_status_t _aidl_ret_status = STATUS_OK;
  ::ndk::ScopedAStatus _aidl_status;
  ::ndk::ScopedAParcel _aidl_in;
  ::ndk::ScopedAParcel _aidl_out;
  ...
  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_in.get(), in_frameCount);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;

  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_in.get(), in_sampleRate);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION && IAudioPluginInterface::getDefaultImpl()) {
    _aidl_status = IAudioPluginInterface::getDefaultImpl()->endPrepare(in_instanceID, in_frameCount, in_sampleRate);
    goto _aidl_status_return;
  }
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::ScopedAStatus BpAudioPluginInterface::process(int32_t in_instanceID, int32_t in_frameCount, int32_t in_timeoutInNanoseconds) {
  ...
  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_in.get(), in_timeoutInNanoseconds);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION && IAudioPluginInterface::getDefaultImpl()) {
    _aidl_status = IAudioPluginInterface::getDefaultImpl()->process(in_instanceID, in_frameCount, in_timeoutInNanoseconds);
    goto _aidl_status_return;
  }
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::SpAIBinder BnAudioPluginInterface::createBinder() {
  AIBinder* binder = AIBinder_new(_g_aidl_org_androidaudioplugin_AudioPluginInterface_clazz, static_cast<void*>(this));
  #ifdef BINDER_STABILITY_SUPPORT
...
std::shared_ptr<IAudioPluginInterface> IAudioPluginInterface::fromBinder(const ::ndk::SpAIBinder& binder) {
  if (!AIBinder_associateClass(binder.get(), _g_aidl_org_androidaudioplugin_AudioPluginInterface_clazz)) {
...
::ndk::ScopedAStatus IAudioPluginInterfaceDefault::beginCreate(const std::string& /*in_pluginId*/, int32_t* /*_aidl_return*/) {
  ::ndk::ScopedAStatus _aidl_status;
  _aidl_status.set(AStatus_fromStatus(STATUS_UNKNOWN_TRANSACTION));
  return _aidl_status;
}
...
::ndk::ScopedAStatus IAudioPluginInterfaceDefault::endPrepare(int32_t /*in_instanceID*/, int32_t /*in_frameCount*/, int32_t /*in_sampleRate*/) {
  ::ndk::ScopedAStatus _aidl_status;
  _aidl_status.set(AStatus_fromStatus(STATUS_UNKNOWN_TRANSACTION));
  return _aidl_status;
}

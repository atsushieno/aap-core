...
static binder_status_t _aidl_onTransact(AIBinder* _aidl_binder, transaction_code_t _aidl_code, const AParcel* _aidl_in, AParcel* _aidl_out) {
  ...
  switch (_aidl_code) {
    ...
    case (FIRST_CALL_TRANSACTION + 6 /*prepare*/): {
      int32_t in_instanceID;
    ...
    case (FIRST_CALL_TRANSACTION + 8 /*activate*/): {
      int32_t in_instanceID;
    ...
    case (FIRST_CALL_TRANSACTION + 9 /*process*/): {
      int32_t in_instanceID;
    ...
    case (FIRST_CALL_TRANSACTION + 10 /*deactivate*/): {
      int32_t in_instanceID;
...
::ndk::ScopedAStatus BpAudioPluginInterface::prepare(int32_t in_instanceID, int32_t in_frameCount, int32_t in_portCount) {
  ...
  _aidl_ret_status = AIBinder_transact(
    asBinder().get(),
    (FIRST_CALL_TRANSACTION + 6 /*prepare*/),
    _aidl_in.getR(),
    _aidl_out.getR(),
    0
    #ifdef BINDER_STABILITY_SUPPORT
...
::ndk::ScopedAStatus BpAudioPluginInterface::activate(int32_t in_instanceID) {
  ...
  _aidl_ret_status = AIBinder_transact(
    asBinder().get(),
    (FIRST_CALL_TRANSACTION + 8 /*activate*/),
    _aidl_in.getR(),
    _aidl_out.getR(),
    0
    #ifdef BINDER_STABILITY_SUPPORT
...
::ndk::ScopedAStatus BpAudioPluginInterface::process(int32_t in_instanceID, int32_t in_timeoutInNanoseconds) {
  ...
  _aidl_ret_status = AIBinder_transact(
    asBinder().get(),
    (FIRST_CALL_TRANSACTION + 9 /*process*/),
    _aidl_in.getR(),
    _aidl_out.getR(),
    0
    #ifdef BINDER_STABILITY_SUPPORT
...
::ndk::ScopedAStatus BpAudioPluginInterface::deactivate(int32_t in_instanceID) {
  ...
  _aidl_ret_status = AIBinder_transact(
    asBinder().get(),
    (FIRST_CALL_TRANSACTION + 10 /*deactivate*/),
    _aidl_in.getR(),
    _aidl_out.getR(),
    0
    #ifdef BINDER_STABILITY_SUPPORT

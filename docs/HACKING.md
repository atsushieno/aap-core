...
When introducing breaking changes in the core API, we should alter the Android Intent action name. In the current API, it is `org.androidaudioplugin.AudioPluginService.V4`.
Before May 2026, it was it is `org.androidaudioplugin.AudioPluginService.V3`.
Before February 2023, it was it is `org.androidaudioplugin.AudioPluginService.V2`.
Before August 2022, it was `org.androidaudioplugin.AudioPluginService.V1`.
Before April 2022, it was `org.androidaudioplugin.AudioPluginService`.
